...
const LoginPage = (props) => {
  ...
  return (
    <div className="bg-[#f3f4f6] w-full min-h-screen  overflow-auto flex items-center justify-center py-3 sm:py-6 md:py-8 px-3 sm:px-4 relative">
      ...
      <Image
        src={Design}
        className="w-full absolute bottom-0 left-0 max-md:hidden"
        width={100}
        height={50}
