...
const RightFold = ({ signUpForm, setSignUpForm, fetchedCountryCodes }) => {
  return (
    <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 justify-center w-full md:w-1/2 items-center bg-white rounded-b-xl md:rounded-bl-none md:rounded-r-xl p-4 sm:p-6 md:p-8">
      <div
