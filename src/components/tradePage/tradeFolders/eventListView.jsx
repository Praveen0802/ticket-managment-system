...
const EventListView = ({ event }) => {
  return (
    <div className=" flex justify-around border-b-[1px] border-[#E0E1EA]">
      <div className="flex py-[22px] w-[30%] px-[12px] flex-col gap-[4px]">
